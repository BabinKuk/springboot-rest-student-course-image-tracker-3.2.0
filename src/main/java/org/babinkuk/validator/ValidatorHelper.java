...
public class ValidatorHelper {
	...
	public List<ValidatorException> validate(ImageVO vo, ActionType action, ValidatorType validatorType) throws ObjectValidationException {
		List<ValidatorException> exceptions = new LinkedList<ValidatorException>();
		
		try {
			validator.validateImage(vo);
		} catch (ValidatorException e) {
			exceptions.add(e);
		}
