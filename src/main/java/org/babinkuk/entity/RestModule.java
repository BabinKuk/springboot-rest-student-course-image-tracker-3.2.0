...
//public class RestModule implements Serializable {
//
//	/**
//	 * 
//	 */
...
//	
//	// bi-directional
//	@OneToMany(mappedBy = "gltModule", // refers to instructor property in GenericLookupTable class
//			fetch = FetchType.LAZY,	
//			cascade = {CascadeType.ALL}) // if RestModule is deleted, delete all associated genericLookupTable rows
//	private GenericLookupTable genericLookupTable;
//	
//	@Column(name = "title")
//	private String title;
//	
//	@Column(name = "rm_decription", length = 64)
