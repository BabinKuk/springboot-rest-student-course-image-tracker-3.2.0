...
INSERT INTO rest_module(rm_id,rm_description,rm_entity_name) values(1,'STUDENT','org.babinkuk.entity.Student');
INSERT INTO rest_module(rm_id,rm_description,rm_entity_name) values(2,'INSTRUCTOR','org.babinkuk.entity.Instructor');
INSERT INTO rest_module(rm_id,rm_description,rm_entity_name) values(3,'COURSE','org.babinkuk.entity.Course');
INSERT INTO rest_module(rm_id,rm_description,rm_entity_name) values(4,'REVIEW','org.babinkuk.entity.Review');
INSERT INTO rest_module(rm_id,rm_description,rm_entity_name) values(5,'IMAGE','org.babinkuk.entity.Image');
